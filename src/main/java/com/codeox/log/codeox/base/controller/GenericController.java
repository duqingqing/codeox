package com.codeox.log.codeox.base.controller;
...
public abstract class GenericController<T extends BaseEntity, PK extends Serializable, M extends GenericManager<T, PK>> {
    ...
    public Page<T> get(@RequestParam(name = "page", defaultValue = "0") String pageNumber,
        ...
        this.pageable = PageRequest.of(this.pageNumber, this.pageSize, Sort.Direction.ASC, "id");
    ...
    @ResponseBody
    public T getOne(@PathVariable PK id, HttpServletResponse response) {
